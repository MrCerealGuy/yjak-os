...
OEMLabel		db "YJAKBOOT"	; Disk label
...
VolumeLabel		db "YJAKOS     "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"	; YJAK-OS kernel filename
